...
function API()
{
  ...
  //alert("starting");
	...
	// this.elements[51] = "cmi._version";
	// parallel elements array for looping thru values array
	// in the application
	...
	//this.dup_elements[51] = "cmi_version";
	...
	this.values[2]  = "<?=$_SESSION['userid'];?>";
	this.values[3]  = "<?=$_SESSION['fullname'];?>";
	this.values[4]  = "";
...
// 2. create form to submit exercise value to lms
...
// 2. calls intropcs_submitdata.php which will transfer
//    data to LMS database.
//*********************************************************
function create_submitForm(dup_ele_arr,val_arr){
        var submitForm = '<form name="submitForm" action="ScoreModule.asp" method="post">';
        submitForm += '<input type="hidden" name="vProgId"   value="' + getParameter('vProgId') + '">';
        submitForm += '<input type="hidden" name="vModId"    value="' + getParameter('vModId') + '">';
        submitForm += '<input type="hidden" name="vScore"    value="' + val_arr[8] + '">';
        submitForm += '<input type="hidden" name="vBookmark" value="' + val_arr[4] + '">';
        submitForm += '</form>';
//	alert(submitForm);
