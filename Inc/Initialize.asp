<%
	...
	Dim oDb, oDb2, oDb3, oDb4, oDb5, oDbBase, oDbBase2, oDbRTE, oDbApp
	Dim oRs, oRs2, oRs3, oRs4, oRs5, oRsBase, oRsBase2, oRsRTE, oRsApp
	Dim oCmd, oCmdBase, oCmdRTE, oCmdApp
 
	'...declare local variables used for session variables
	Dim svServer, svHostDb, svHostDbPwd, svHostDbId, svMailServer, svHost, svSQL, svSSL, svDomain, svFontNo
	...
	Dim svMembId, svMembPwd, svMembNo, svMembFirstName, svMembLastName, svMembLevel, svMembFirstVisit, svMembLastVisit, svMembNoVisits, svMembNoHours, svMembExpires, svMembEmail, svMembCriteria, svMembManager, svMembInternal
	Dim svSecure, svCurrVisit, svLang, svProcesses, svPrograms, svProgram, svMultiUserManual, svPage, svTranslate, svEcomBypass, svBrowser, svProdNo, svProdMax, sv8
...
'	Session("SQL") = "vmsql-01"       '...used for local testing with live DB - DANGEROUS
	...
	Session("HostDbPwd")      = "C8WDEzy9HPzjnDpWcFYm5UXk"                                        : svHostDbPwd = Session("HostDbPwd") 
...
'  stop
		...
		oDb.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
	...
	Sub sOpenDb2
		...
		oDb2.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
	...
	Sub sOpenDb3
		...
		oDb3.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
	...
	Sub sOpenDb4
		...
		oDb4.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
	...
	Sub sOpenDb5
		...
		oDb5.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
	...
	Sub sOpenDbBase
		...
		oDbBase.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Base;Data Source=" & svSQL
		oDbBase.Open
		If Err.Number = 0 or Err.Number = "" Then vFileOk = True
	End Sub
	...
	Sub sOpenDbBase2
		...
		oDbBase2.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Base;Data Source=" & svSQL
		oDbBase2.Open
		If Err.Number = 0 or Err.Number = "" Then vFileOk = True
	End Sub
	...
	Sub sOpenCmdApp
		sOpenDbApp
		Set oCmdApp = Server.CreateObject("ADODB.Command")
		Set oCmdApp.ActiveConnection = oDbApp
		oCmdApp.CommandType = adCmdStoredProc
		oCmdApp.CommandTimeout = 60000
	End Sub

	Sub sOpenDbApp
		On Error Resume Next
		vFileOk = False
		Set oDbApp = Server.CreateObject("ADODB.Connection")
		oDbApp.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 EcomLogs Apps;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=apps;Data Source=" & svSQL
		oDbApp.Open
		If Err.Number = 0 or Err.Number = "" Then vFileOk = True
	End Sub
	...
	End Sub
		...
		oDbRTE.ConnectionString = "Provider=SQLOLEDB.1;Application Name=V5 Platform;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=V5_Vubz;Data Source=" & svSQL
...
'       fMaxDate = j '... this was the original code - dead wrong
				fMaxDate = i
			End If  
...
'     fLeft = Left(i, j) & "<a title='" & i & "' href='#'><span class='green'>...</span></a>"
	...
	Sub sTableUpdate(vDb, vTable, vKey)
		...
		vFileOk = False
		Set oDb = Server.CreateObject("ADODB.Connection")
		oDb.ConnectionString = "Provider=SQLOLEDB.1;Password=" & svHostDbPwd & ";Persist Security Info=True;User ID=" & svHostDbId & ";Initial Catalog=" & vDb & ";Data Source=" & svSQL
		oDb.Open
