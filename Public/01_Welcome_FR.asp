...
<!--      <li><a onmouseover="javascript:window.status=' ';return true" onmousedown="javascript:window.status=' ';return true" onmouseout="javascript:window.status=' ';return true" target="_top" href="/V5/Default.asp?vLang=FR">FranÃ§ais</a></li>-->          
    ...
    <tr>
      ...
      <div id="navcontainer3">
        <ul id="navlist3">
          <li><a href="BrowserIssues_FR.htm">Problèmes liés aux navigateurs?</a></li>
        </ul>
      </div>      
