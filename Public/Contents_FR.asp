...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" text="#000080" link="#000080" vlink="#000080" alink="#000080">
  ...
  <div align="center">
    <table border="0" cellspacing="0" cellpadding="5" bordercolor="#DDEEF9" class="c2" width="150">
      <tr>
        <td class="c2"><b><br><a href="Archives/01_Welcome_EN.asp">Welcome</a></b></td>
      </tr>
      <tr>
        <td class="c2"><b><a target="_top" href="Cat_Start.asp">Catalogue</a><br>&nbsp;</b></td>
      </tr>
...
-->
  ...
  <div align="center">
    <table cellspacing="0" cellpadding="6" border="1" id="table2" style="border-collapse: collapse" bordercolor="#DDEEF9" width="151">
      <form method="GET" action="../Default.asp" target="_top">
        <tr>
          <td class="c2">
            <p class="c2"><b>New Programs !</b></p><p class="c2">Small Business <br>Management Certificate<p class="c2"><a href="http://gpecertifcat.com/default.asp?vMemo=VUBZ_P&vSource=http://vubiz.com" target="_top"><img border="0" src="../Images/SPC/SBMC/SBMC_SM_FR.jpg" align="absbottom" width="107" height="50"></a><br><br>Small Exporters<br>Management Certificate<p class="c2"> <a href="http://gpeecertificat.com/default.asp?vMemo=VUBZ_P&vSource=http://vubiz.com" target="_top"><img border="0" src="../Images/SPC/SEMC/SEMC_SM_FR.jpg" align="absbottom" width="118" height="50"></a>            <input type="hidden" name="vLang" value="EN">
          </td>
        </tr>
      </form>
    </table>
