...
<%
  ...
  Sub sReadCust
    ...
    vResponseXML =  "    <Customer>" _
                  & "      <vCust_Id>"      & oRs("Cust_Id")                         & "</vCust_Id>"      _
                  & "      <vCust_AcctId>"  & oRs("Cust_AcctId")                     & "</vCust_AcctId>"  _
                  & "      <vCust_Title>"   & oRs("Cust_Title")                      & "</vCust_Title>"   _
                  & "      <vCust_Lang>"    & oRs("Cust_Lang")                       & "</vCust_Lang>"    _
                  & "      <vCust_Prgms>"   & fStripOutPrgms(oRs("Cust_Programs"))   & "</vCust_Prgms>"   _
  ...
  Sub sReadCustMods
       sOpenDbBase
       vSql = "Select Prog_Mods FROM Prog WHERE Prog_Id = '" & Replace(vCust_Prgms, " ", "' OR Prog_Id = '") & "'"
       Set oRs = oDbBase.Execute(vSQL)    
       If Not oRs.Eof Then 
         Dim vModList
         Do While Not oRs.Eof
            vModList = vModList & oRs("Prog_Mods") & " "
            oRs.MoveNext
         Loop 
         vResponseXML = "      <vCust_Mods>" & vModList & "</vCust_Mods>"    _
                      & "    </Customer>" 
         vCust_Eof = False
       Else
         vCust_Eof = True
  ...
  Sub sReadMemb
    vResponseXML =  "    <Member>" _
                  ...
                  & "      <vMemb_Id>"        & oRs("Memb_Id")        & "</vMemb_Id>"          _
                  & "      <vMemb_No>"        & oRs("Memb_No")        & "</vMemb_No>"          _
                  & "      <vMemb_FirstName>" & oRs("Memb_FirstName") & "</vMemb_FirstName>"   _
                  & "      <vMemb_LastName>"  & oRs("Memb_LastName")  & "</vMemb_LastName>"    _
                  & "      <vMemb_Email>"     & oRs("Memb_Email")     & "</vMemb_Email>"       _
