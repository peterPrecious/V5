...
<head>
  <title>Programme de formation des formateurs sur la L P H O</title>
...
<%  
    ...
    Else
      ...
      If Not vError Then
  %>
<p align="center"><font face="Arial" color="#800000"><b>Merci de votre collaboration. 
  Vos commentaires nous sont précieux.</b></font></p>
  
  
<%
      Else
  %>
<p align="center"><font face="Arial" color="#800000"><b>Une erreur nous empêche 
  de traiter votre sondage. Veuillez avertir VUBIZ.<br>
  Please email <a href="<%=Request.Form("Recipient")%>"><%=Request.Form("Recipient")%></a><br>
  Merci</b></font></p>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <form id="form1" name="form1">
          <input type="button" name="Close" onclick="window.close()" value="Fermez la fenêtre">
        </form>
        </td>
      </tr>
    </table>
