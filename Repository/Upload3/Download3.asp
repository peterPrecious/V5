...
<% 
  ...
  vSql = "SELECT "_
       ...
       & "  Facs.Memb_Id          AS [Reports To] "_

       & "FROM "_         
       & "  Memb                                                            LEFT OUTER JOIN "_
       & "  Memb AS Facs          ON Memb.Memb_Group2 = Facs.Memb_No        LEFT OUTER JOIN "_
...
' stop
  ...
  Sub sExcelInit
    ...
    vCol = vCol + 1 : oCell(vRow, vCol) = "Reports To"      : oCell(vRow, vCol).Format.Font.Bold = True : oCell.ColumnWidth(vCol) = 32
