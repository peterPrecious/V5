...
<body>
  ...
  <div style="text-align: center">
    ...
    <div style="text-align: center">
      ...
      <a style="padding-right:40px;" href="MyWorld2.asp?vTskH_AcctId=<%=vTskH_AcctId%>&vTskH_Id=<%=vTskH_Id%>&vToggle=999"><!--webbot bot='PurpleText' PREVIEW='Expand All Nodes'--><%=fPhra(000135)%></a> 
      <% End If %>

      <a href="MyWorld2.asp?vTskH_AcctId=<%=vTskH_AcctId%>&vTskH_Id=<%=vTskH_Id%>&vToggle=998"><!--webbot bot='PurpleText' PREVIEW='Collapse All Nodes'--><%=fPhra(000105)%></a>
