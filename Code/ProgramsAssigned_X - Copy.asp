...
<% 
  ...
  Sub sExcelInitHeader
    ...
    oCell(vRow + 1, vCol) = fPhraH(000203)             : oCell(vRow + 1, 01).Format.Font.Bold = True
    oCell(vRow + 2, vCol) = fPhraH(000880)      : oCell(vRow + 2, 01).Format.Font.Bold = True
    oCell(vRow + 3, vCol) = fPhraH(000881)       : oCell(vRow + 3, 01).Format.Font.Bold = True
    oCell(vRow + 4, vCol) = fPhraH(000882)    : oCell(vRow + 4, 01).Format.Font.Bold = True
    oCell(vRow + 5, vCol) = fPhraH(000884)          : oCell(vRow + 5, 01).Format.Font.Bold = True
