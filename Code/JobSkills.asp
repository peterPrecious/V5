...
<body>
  ...
  <table border="1" style="border-collapse: collapse" cellspacing="0" cellpadding="4" bordercolor="#DDEEF9" width="100%" id="table1">
    <form method="POST" action="JobSkills.asp">
      ...
      %>
      <tr>
        <td valign="top" align="center" colspan="4">&nbsp;<p><a href="MyWorld.asp?vTskH_Id=<%=Request("vTskH_Id")%>"><img border="0" src="../Images/Icons/World.gif" alt="<%=Server.HtmlEncode("<!--webbot bot='PurpleText' PREVIEW='Return to My Learning'--><%=fPhra(000331)%>")%>"></a></p>
