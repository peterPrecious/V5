...
<head>
  ...
  <table cellpadding="3" border="0" id="table2" width="100%" bordercolor="#DDEEF9" style="border-collapse: collapse">
    ...
    <tr>
      ...
      <td align="center"><h1><!--webbot bot='PurpleText' PREVIEW='My Programs'--><%=fPhra(000186)%></h1><h2 align="left"> <!--webbot bot='PurpleText' PREVIEW='Learning programs available to you are listed by category below. Each program can contain one or more learning modules. Clicking on a program title will display the included modules in the right frame.&nbsp; Access any module by clicking on the module title.'--><%=fPhra(000170)%></h2>
      ...
      <h2 align="center"><a <%=fStatX%> target="_self" href="Ecom2MyPrograms.asp"><!--webbot bot='PurpleText' PREVIEW='My Programs'--><%=fPhra(000186)%></a> | <a <%=fStatX%> target="_self" href="Ecom2MyPrograms.asp?vMode=All"><!--webbot bot='PurpleText' PREVIEW='All Programs'--><%=fPhra(000068)%></a></h2>
      <% 
          End If      
        End If 
      %> 
...
%>
    ...
    <tr>
      ...
      <% If vMode <> "All" Then %>
      <td bgcolor="#DDEEF9" valign="top" bordercolor="#FFFFFF" align="center" nowrap><p class="c2"><!--webbot bot='PurpleText' PREVIEW='Expires<br>beginning of...'--><%=fPhra(000138)%></p></td>
      <% End If %>
    </tr>
