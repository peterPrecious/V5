    ...
    <div id="Div_Notes" class="div">
      <table class="table">
        ...
        <tr>
          <th>Start URL : </th>
          <td>
            <input type="text" size="80" name="vCust_StartUrl" value="<%=vCust_StartUrl_Original%>"><br>This is where the customer goes to sign in or enroll into Vubiz. ie /ChAccess/CAST/default_<%=svLang%>.asp. Note: do not precede with &quot;//&quot;. If there are different URLS for different languages, then separate them with pipes in EN|FR|ES order.
          </td>
        </tr>
        <tr>
          <th>Return URL : </th>
