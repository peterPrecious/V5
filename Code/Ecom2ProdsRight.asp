  ...
  <table border="1" style="border-collapse: collapse" bordercolor="#DDEEF9" width="100%" cellspacing="0" cellpadding="3">
   ...
   %>
    ...
    <tr>
      ...
      <!--webbot bot='PurpleText' PREVIEW='Applicable taxes extra for Canadian orders.'--><%=fPhra(000072)%>&nbsp; <br><a <%=fStatX%> href="javascript:SiteWindow('Ecom2PoliciesProds.asp?vClose=Y')">
      <!--webbot bot='PurpleText' PREVIEW='Shipping and handling charges extra.'--><%=fPhra(000238)%></a><br>&nbsp;</p>
      </td>
    </tr>
  </table>
