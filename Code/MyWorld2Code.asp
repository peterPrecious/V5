...
'       fAccess = "<a name='" &  vTskH_Order & "' href='MyWorld2Redirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "#" &  vTskH_Order & "'><img border='0' src='../Images/Common/VuPlus.gif'  alt='" & Server.HtmlEncode(fPhraH(000136)) & "'></a>"
        fAccess = "<a name='" &  vTskH_Order & "' href='MyWorld2Redirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "'><img border='0' src='../Images/Common/VuPlus.gif'  alt='" & Server.HtmlEncode(fPhraH(000136)) & "'></a>"
      Else
'...anchor bug in XP SP2 - removed
'       fAccess = "<a name='" &  vTskH_Order & "' href='MyWorld2Redirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "#" &  vTskH_Order & "'><img border='0' src='../Images/Common/VuMinus.gif' alt='" & Server.HtmlEncode(fPhraH(000106)) & "'></a>"
        fAccess = "<a name='" &  vTskH_Order & "' href='MyWorld2Redirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "'><img border='0' src='../Images/Common/VuMinus.gif' alt='" & Server.HtmlEncode(fPhraH(000106)) & "'></a>"
      End If
    End If
  End Function
