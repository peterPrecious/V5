...
' sDebug
  ...
  Sub sExcelInit
    ...
    oCell(vRow, 01) = fPhraH(000187)															: oCell(vRow, 01).Format.Font.Bold = True : oCell.ColumnWidth(01) = 32
    oCell(vRow, 02) = fIf(svCustPwd, fPhraH(000411), fPhraH(000211))	: oCell(vRow, 02).Format.Font.Bold = True : oCell.ColumnWidth(02) = 20
    oCell(vRow, 03) = fPhraH(000273)		 											              : oCell(vRow, 03).Format.Font.Bold = True : oCell.ColumnWidth(03) = 10
