  ...
  <table border="1" style="border-collapse: collapse" width="100%" id="table1" bordercolor="#DDEEF9">
    <tr>
      ...
      <div align="center">
        ...
        <p><br><a href="MyWorld.asp?vTskH_Id=<%=Request("vTskH_Id")%>"><img border="0" src="../Images/Icons/World.gif" alt="<%=Server.HtmlEncode("<!--webbot bot='PurpleText' PREVIEW='Return to My Learning'--><%=fPhra(000331)%>")%>"></a></p><p><a href="javascript:history.back(1)"><img border="0" src="../Images/Buttons/Return_<%=svLang%>.gif"></a></p></div>
      <p></p></td>
    </tr>
  </table>
