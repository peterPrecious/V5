...
<body leftmargin="0" topmargin="0" bgcolor="#FFFFFF" text="#000080" link="#000080" vlink="#000080" alink="#000080">
  ...
  <form action="https://secure.internetsecure.com/process.cgi" method="POST" target="_top" id="theForm">
    ...
    <input type="hidden" name="ReturnCGI"       value="/V5/Code/EcomMemoOk.asp">
    ...
    <table border="0" width="600" bordercolor="#111111" cellpadding="10" cellspacing="0">
      <tr>
        <td align="center">
          ...
          <p align="left">Please enter the Amount you wish to pay Vubiz (ie 5500 for five thousand five hundred dollars) then click Submit.&nbsp;You will be transferred to &quot;InternetSecure&quot; where you can enter the Credit Card details.&nbsp; You do not need to returned to this site after the transaction is complete. An email will be sent by InternetSecure showing the transaction.</p>
          <input type="text" name="txtAmount" id="txtAmount" size="11"> 
          <input type="button" onclick="submitForm('theForm')" value="Submit" name="bContinue" class="button"> <br><font color="#FF0000">ONLY CLICK SUBMIT ONCE!</font><br><br>
