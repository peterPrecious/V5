...
<body>
  ...
  <div id="divLoader" style="margin: 30px; text-align: center;">
    <h1>
      <!--webbot bot='PurpleText' PREVIEW='Generating your Learner Report Card'--><%=fPhra(001517)%></h1>
      ...
      <table class="table">
        ...
        <tr id="progList" class="advanced">
          ...
          <td id="cellProgList" colspan="2">
            ...
            <!--webbot bot='PurpleText' PREVIEW='Note: this list only shows Programs that have been accessed.'--><%=fPhra(001574)%>
          </td>
        </tr>
        <tr id="modsList" class="advanced">
          ...
          <td id="cellModsList" colspan="2">
            ...
            <!--webbot bot='PurpleText' PREVIEW='Note: this list only shows Modules that have been accessed.'--><%=fPhra(001575)%>
          </td>
        </tr>
        <tr>
          <th>
