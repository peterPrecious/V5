<% 
  Sub sEmailAlert (vEmail_Notify, vSubject, vEmail_Note, vEmail_Type)
    ...
    For i = 0 to iMax
      ...
      vBody              = "<br>"
      vBody              = vBody & fPhraH(000408) & " " & vFirstName & ",<br><br>"
      vBody              = vBody & vEmail_Type & " " & fPhraH(000813) & ":<br>"
      ...
      End If
      vBody              = vBody & "<br><br>" & fPhraH(000246) & "<br>" & svMembFirstName
...
%>
    <table border="1" width="100%" style="border-collapse: collapse" bordercolor="#DDEEF9" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center">
        <h6><br>
        <!--webbot bot='PurpleText' PREVIEW='The following could not be alerted:'--><%=fPhra(000362)%> <br><%=vErr%> </h6>
        <h6>
        <!--webbot bot='PurpleText' PREVIEW='Their email addresses may be invalid.'--><%=fPhra(000363)%> <br>
        <!--webbot bot='PurpleText' PREVIEW='Please contact your facilitator.'--><%=fPhra(000364)%></h6>
