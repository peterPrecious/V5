...
<body>
  ...
  <% Server.Execute vShellHi %>
    ...
    <h2><!--webbot bot='PurpleText' PREVIEW='This report, sorted by Last Name, shows all selected Learners who have accessed content between ^0 and ^1.'--><%=fPhra(001819)%></h2>
    <h3><!--webbot bot='PurpleText' PREVIEW='Click Details for the Learner Report Card.&nbsp; Click on the Learner's Name to access the Learner's Profile.'--><%=fPhra(001820)%></h3>       
    <br />      
    ...
    <table class="table">
      ...
      <tr class="t1">
        ...
        <th class="rowshade"><!--webbot bot='PurpleText' PREVIEW='Learner's Name'--><%=fPhra(000893)%></th>
        <th class="rowshade"><%=fIf(svCustPwd, fPhraH(000411), fPhraH(000211))%></th>
        <th class="rowshade"><!--webbot bot='PurpleText' PREVIEW='Memo'--><%=fPhra(000173)%></th>
...
'       vUrl = Server.UrlEncode(vUrl)
    %>
      ...
      <tr>
        <th colspan="5"><!--webbot bot='PurpleText' PREVIEW='No learners have been selected.'--><%=fPhra(000869)%></th>
      </tr>
      <% End If %> 
