        ...
        <table class="table">
          <tr id="R_<%=vRow %>" onmouseover="hiLiteRow(this, 'bgOn')" onmouseout="hiLiteRow(this, 'bgOff')">
            <td class="underline" style="width: 665px">
              <%=vProg_Title%>
              <a href="javascript:hiLiteRow($('#R_<%=vRow %>'), 'bgAlert'); openWindow('P', '<%=vProg_Id%>', '')"><!--webbot bot='PurpleText' PREVIEW='Description'--><%=fPhra(000118)%></a>
            ...
            <td colspan="3">
              <div style="text-align: right;">
                ...
                <table class="table">
                  ...
                  %>
                  <tr id="R_<%=vRow %>" onmouseover="hiLiteRow(this, 'bgOn')" onmouseout="hiLiteRow(this, 'bgOff')">
                    <td class="underline" style="width: 665px"><%=f5%><%=RTE_ModsTitle%> <a href="javascript:hiLiteRow($('#R_<%=vRow %>'), 'bgAlert'); openWindow('M', '<%=RTE_ProgId%>', '<%=RTE_ModsId%>')"><!--webbot bot='PurpleText' PREVIEW='Description'--><%=fPhra(000118)%></a><% If svMembLevel > 4 Then %> <span class="green"><a class="green" target="_blank" href="Module.asp?vMods_Id=<%=RTE_ModsId%>"><%=RTE_ModsType%></a></span><% End If %><%=fFeatures%></td>
