  ...
  <table id="menuTable" style="width: 80%; max-width: 800px; text-align: center; margin: auto;">
    ...
    <tr>
      <td class="c2" colspan="2">
        <!--webbot bot='PurpleText' PREVIEW='Facilitator Services'--><%=fPhra(000259)%></td>
    </tr>
    <tr>
      <td colspan="2">
        <table class="table">
...
<!--          <tr>
          ...
          <tr>
            <td>&nbsp; <a <%=fstatx%> href="ProgramsAssigned.asp">
              <!--webbot bot='PurpleText' PREVIEW='Programs Purchased and Assigned'--><%=fPhra(000886)%></a></td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td>&nbsp; <a <%=fstatx%> target="_blank" href="/Gold/vuClientReporting/ReportViewerFrame.aspx?AccountID=<%=svCustAcctId%>&reportfile=App_Data/repLearnerCompletion.frx">
              <!--webbot bot='PurpleText' PREVIEW='Completion Status Report (Online)'--><%=fPhra(001702)%></a></td>
            <td style="text-align: left;">
              ...
              <div style="text-align: left; margin-left: 20px" id="div_R1" class="div">
                <!--webbot bot='PurpleText' PREVIEW='Lists completions/incompletions for all<br />programs assigned to your Learners.'--><%=fPhra(001589)%>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td>&nbsp; <a <%=fstatx%> target="_blank" href="/Gold/vuclientReporting/ReportExport.aspx?AccountID=<%=svCustAcctId%>&reportfile=repLearnerCompletionExport.frx&type=CSV">
              <!--webbot bot='PurpleText' PREVIEW='Completion Status Report (CSV)'--><%=fPhra(001703)%></a></td>
            <td style="text-align: left;">
              <a class="green" href="javascript:toggle('div_R2');">Description</a>
              <div style="text-align: left; margin-left: 20px" id="div_R2" class="div">
                <!--webbot bot='PurpleText' PREVIEW='Creates a CSV file of completions/incompletions for all<br />programs assigned to your Learners'--><%=fPhra(001704)%>
              </div>
            </td>
          </tr>

          <tr>
            <td>&nbsp; <a <%=fstatx%> target="_blank" href="/Gold/vuclientreporting/ReportExport.aspx?AccountID=<%=svCustAcctId%>&reportfile=repLearnerIncompleteCourseExport.frx&type=CSV"><!--webbot bot='PurpleText' PREVIEW='InCompletion Report (CSV)'--><%=fPhra(001705)%></a></td>
            <td style="text-align: left;">
          ...
          <%   If Instr(svHost, "stagingweb") > 0 Or Instr(svHost, "localhost") > 0   Then %>
