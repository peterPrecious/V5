...
<body id="Vubix" onload="initTSelements(); initBMelements(); initSCelements();">
  ...
  <h1><!--webbot bot='PurpleText' PREVIEW='Learner Report Card'--><%=fPhra(000795)%>&nbsp;<!--webbot bot='PurpleText' PREVIEW='for'--><%=fPhra(000797)%>&nbsp;<%=fMembName (vMemb_No)%></h1>

  <div class="c2" style="width:90%; margin:auto;">
    <!--webbot bot='PurpleText' PREVIEW='This displays the complete learning activities sorted by Program Title. A Program must have been accessed for it to appear on the Report Card. For example, if 3 Programs were assigned or purchased but only the first was started, then only the first Program will appear here. Click on the Program Id to view that Program's activities (the first Program is always listed).'--><%=fPhra(001258)%>&nbsp; 
    <% If svMembLevel > 2 Then %><!--webbot bot='PurpleText' PREVIEW='Click on a Best Score that represents a passing grade to yield a certificate.'--><%=fPhra(001259)%><% End If %>&nbsp; 
  ...
  <div style="margin:20px; text-align:center;">
    <a class="c3" href="javascript:openDivs()"><!--webbot bot='PurpleText' PREVIEW='Show All Details'--><%=fPhra(001261)%></a> <%=f10%>
    <a class="c3" href="javascript:hideDivs()"><!--webbot bot='PurpleText' PREVIEW='Hide All Details'--><%=fPhra(001262)%></a>
  </div>    
...
'   		sDebug
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;<!--webbot bot='PurpleText' PREVIEW='Purchaser:'--><%=fPhra(000798)%> <%=vPurchaser%></td>
      <td colspan="2"><!--webbot bot='PurpleText' PREVIEW='Purchased:'--><%=fPhra(000799)%> <%=fFormatDate(vPurchased)%></td>
      <td><!--webbot bot='PurpleText' PREVIEW='Expires:'--><%=fPhra(000800)%> <%=fFormatDate(vExpires)%></td>
    </tr>
    <%
    		End If
    		Set oRs2 = Nothing
  ...
  <div class="div" id="Div_<%=oRs("Prog_Id")%>" style="padding-top: 5px; padding-bottom: 20px">
    <table class="table">
      <tr>
        <th style="width:40%; white-space:nowrap; text-align:left;" colspan="2" ><!--webbot bot='PurpleText' PREVIEW='Module/Assessment'--><%=fPhra(000793)%></th>
        <th style="width:10%; white-space:nowrap; text-align:center;"><!--webbot bot='PurpleText' PREVIEW='Time'--><%=fPhra(000273)%><br><!--webbot bot='PurpleText' PREVIEW='Spent'--><%=fPhra(001394)%><br><span style="font-weight: 400">(<!--webbot bot='PurpleText' PREVIEW='Mins'--><%=fPhra(001395)%>)</span></th>
        <th style="width:10%; white-space:nowrap; text-align:center;"><!--webbot bot='PurpleText' PREVIEW='Book'--><%=fPhra(001396)%><br><!--webbot bot='PurpleText' PREVIEW='Mark'--><%=fPhra(000575)%></th>
        <th style="width:10%; white-space:nowrap; text-align:center;">#<br><!--webbot bot='PurpleText' PREVIEW='Attempts'--><%=fPhra(000802)%></th>
        <th style="width:10%; white-space:nowrap; text-align:center;"><!--webbot bot='PurpleText' PREVIEW='Best'--><%=fPhra(001397)%> <br><!--webbot bot='PurpleText' PREVIEW='Score'--><%=fPhra(000232)%> %<br><span style="font-weight: 400">(<!--webbot bot='PurpleText' PREVIEW='Cert'--><%=fPhra(000941)%>)</span></th>
        <th style="width:10%; white-space:nowrap; text-align:center;"><!--webbot bot='PurpleText' PREVIEW='Best'--><%=fPhra(001397)%> <br><!--webbot bot='PurpleText' PREVIEW='Score'--><%=fPhra(000232)%> <br>Date</th>
  ...
  <div class="div" id="Div_P0000XX" style="padding-top: 5px; padding-bottom: 20px">
    <table style="border-collapse: collapse" border="1" bordercolor="#DDEEF9" width="90%">
      <tr>
        ...
        <!--webbot bot='PurpleText' PREVIEW='Exam'--><%=fPhra(000573)%></th>
        <th style="white-space:nowrap">#<br>
        <!--webbot bot='PurpleText' PREVIEW='Attempts'--><%=fPhra(000802)%></th>
        <th style="white-space:nowrap">
        <!--webbot bot='PurpleText' PREVIEW='Best'--><%=fPhra(001397)%><br><!--webbot bot='PurpleText' PREVIEW='Score'--><%=fPhra(000232)%> %<br><span style="font-weight: 400">(<!--webbot bot='PurpleText' PREVIEW='Cert'--><%=fPhra(000941)%>)</span></th>
        <th style="white-space:nowrap">
        <!--webbot bot='PurpleText' PREVIEW='Best<br>Score'--><%=fPhra(000608)%><br>Date</th>
        <th style="white-space:nowrap">
...
//  open1Div('Div_<%=vDiv%>');
  ...
  <% Else %> 
  <p class="red"><!--webbot bot='PurpleText' PREVIEW='There are no learning activities on file.'--><%=fPhra(000864)%></p>
  <% End If %>
