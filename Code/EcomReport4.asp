  ...
  <div align="center">
    ...
    <table border="0" cellpadding="4" style="border-collapse: collapse" bordercolor="#DDEEF9">
        ...
        <table border="0" cellspacing="0" cellpadding="5" style="border-collapse: collapse" bordercolor="#111111" width="523">
          <form method="POST" action="EcomReport4.asp">
            ...
            <tr>
              ...
              <td width="68%" nowrap><input type="text" name="vStrDate" size="9" value="<%=vStrDate%>" class="c2"> <a title="<!--webbot bot='PurpleText' PREVIEW='Start with First Sale.'--><%=fPhra(001429)%>" onclick="fillField('vStrDate', 'Jan 1, 2000')" href="#">&#937;</a>&nbsp; <span style="background-color: #FFFF00"><%=vStrDateErr%></span><br>
              ie Jan 1, 2010 (MMM DD, YYYY).&nbsp;
              Click &#937; to start with first sale.</td>
            </tr>
            <tr>
              <th align="right" valign="top" width="30%" nowrap>Select End Date :</th>
              <td width="68%" nowrap><input type="text" name="vEndDate" size="9" value="<%=vEndDate%>" class="c2"> <a title="<!--webbot bot='PurpleText' PREVIEW='Finish with Last Sale.'--><%=fPhra(001430)%>" onclick="fillField('vEndDate', '<%=fFormatDate(DateAdd("d", 1, Now()))%>')" href="#">&#937;</a>&nbsp; <span style="background-color: #FFFF00"><%=vEndDateErr%></span><br>
            ...
            <tr>
              ...
              <td align="left" width="68%" nowrap><input type="text" name="vPrograms" size="42" value="<%=vPrograms%>" class="c2"> <a title="<!--webbot bot='PurpleText' PREVIEW='Include all Programs'--><%=fPhra(001431)%>" onclick="fillField('vPrograms', '')" href="#">&#937;</a><br>
              ie P1234EN P2223ES<br>
              Leave empty (&#937;) to show all Programs</td>
            </tr>
            <tr>
              <th align="right" valign="top" width="30%" nowrap>For <%=fIf(svCustPwd, fPhraH(000374), fPhraH(000211))%> :</th>
              <td align="left" width="68%" nowrap><input type="text" name="vPassword" size="20" value="<%=vPassword%>"> <a title="<!--webbot bot='PurpleText' PREVIEW='Include all Programs'--><%=fPhra(001431)%>" onclick="fillField('vPassword', '')" href="#">&#937;</a><br>Optionally enter ONE <%=fIf(svCustPwd, fPhraH(000374), fPhraH(000211))%> to report on one learner.<br>Leave empty (&#937;) to include all Learners</td>
            </tr>
            <tr>
      ...
      <tr>
        ...
        <th height="20" bgcolor="#DDEEF9" bordercolor="#FFFFFF" align="left"><%=fIf(svCustPwd, fPhraH(000374), fPhraH(000211))%></th>
