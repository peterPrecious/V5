...
<body>
  ...
  <h1><!--webbot bot='PurpleText' PREVIEW='Assessment Report'--><%=fPhra(000074)%></h1>
  ...
  <table class="table">
    <tr>
      ...
      <th class="rowshade" style="width:10%"><%=fIf(svCustPwd, fPhraH(000411), fPhraH(000211))%></th>
      <th class="rowshade" style="width:15%"><!--webbot bot='PurpleText' PREVIEW='Learner'--><%=fPhra(000165)%></th>
      <th class="rowshade" style="width:10%"><!--webbot bot='PurpleText' PREVIEW='Date'--><%=fPhra(000112)%></th>
      <th class="rowshade" style="width:40%"><!--webbot bot='PurpleText' PREVIEW='Title'--><%=fPhra(000019)%> </th>
      <th class="rowshade" style="width:05%"><!--webbot bot='PurpleText' PREVIEW='Score'--><%=fPhra(000232)%></th>
    </tr>
    <% 
...
'       If fCriteriaOk (svMembCriteria, vMemb_Criteria) Then
    ...
    <tr>
      ...
      %>
      <a href="LogReport5AO.asp"><!--webbot bot='PurpleText' PREVIEW='Next Group'--><%=fPhra(000834)%></a>
      <%
        Else 
          Set oRs = Nothing
        End If      
