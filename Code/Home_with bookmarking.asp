...
<div class="c2" align="left">
  ...
  <% If vCust_Tab2 Then %><!--webbot bot='PurpleText' PREVIEW='Click on the <b>My Learning</b> tab above to access your programs.'--><%=fPhra(000486)%>&nbsp;<% End If %>
  <% If vCust_Tab3 Then %><!--webbot bot='PurpleText' PREVIEW='Click on the <b>My Content</b> tab above to access your free or purchased programs.'--><%=fPhra(000101)%>&nbsp;<% End If %>
  <% If vCust_Tab5 Then %><!--webbot bot='PurpleText' PREVIEW='To purchase e-learning programs, click <b>More Content</b> to complete a secure e-commerce process.&nbsp;&nbsp; Any programs purchased will then appear under the <b>My Content</b> tab above.'--><%=fPhra(000513)%>&nbsp;<% End If %>
...
<% If vCust_InfoEditProfile Then %> 
  ...
  <!--webbot bot='PurpleText' PREVIEW='My profile'--><%=fPhra(000185)%></font></font></p><h2 align="left">
  <!--webbot bot='PurpleText' PREVIEW='Enter/edit your name and email address below. Your name will then appear on any certificates issued for successful completion of assessments or exams.'--><%=fPhra(000129)%></h2>
      ...
      <tr>
        <td>
          <table border="0" style="border-collapse: collapse" id="table2" cellpadding="2">
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='First Name'--><%=fPhra(000156)%> :</th>
              <td>
            ...
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='Last Name'--><%=fPhra(000163)%> :</th>
              <td>
                <% If Request.QueryString("vAction") = "edit" Then %>
            ...
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='Password'--><%=fPhra(000211)%> :</th>
              <td>
                <% If Request.QueryString("vAction") = "edit" Then %>
            ...
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='Email Address'--><%=fPhra(000126)%> :</th>
              <td>
                <% If Request.QueryString("vAction") = "edit" Then %>
            ...
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='First Visit'--><%=fPhra(000157)%> :</th>
              <td><%=fFormatDate(svMembFirstVisit)%></td>
            </tr>
      
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='Last Visit'--><%=fPhra(000164)%> :</th>
            ...
            %>
            <tr>
              <th align="right" nowrap><!--webbot bot='PurpleText' PREVIEW='Access Expires'--><%=fPhra(000357)%> :</th>
