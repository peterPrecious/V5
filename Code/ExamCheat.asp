...
<body leftmargin="0" topmargin="0" bgcolor="#FFFFFF" text="#000080" link="#000080" vlink="#000080" alink="#000080">
  ...
  <div align="center">
    ...
    <table border="1" width="90%" cellspacing="0" cellpadding="0" bordercolor="#DDEEF9" style="border-collapse: collapse">
      <tr>
        <td align="center"><h1>
        <!--webbot bot='PurpleText' PREVIEW='Examination Instructions'--><%=fPhra(000134)%></h1>
        <h6><br>
        <!--webbot bot='PurpleText' PREVIEW='You have manipulated the Browser in such a way that the current test has been contaminated'--><%=fPhra(000046)%>.<br><br>
        <!--webbot bot='PurpleText' PREVIEW='For future reference, ONLY click buttons available to you within the Examination pages'--><%=fPhra(000158)%>.<br><br>&nbsp;</h6>
