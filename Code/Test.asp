...
<html>
  <head>
    ...
    <title><!--webbot bot='PurpleText' PREVIEW='Self Assessment'--><%=fPhra(000235)%></title>
  </head>
    ...
    <table border="1" width="100%" cellpadding="3" cellspacing="0" bordercolor="#DDEEF9" style="border-collapse: collapse">
      <tr>
        <td colspan="2">
          ...
          <p>
          <!--webbot bot='PurpleText' PREVIEW='Please endeavour to answer all questions by clicking the radio button beside your answer. When finished, click &quot;next&quot; below for grading.'--><%=fPhra(000298)%> <font color="#FF0000">
          <!--webbot bot='PurpleText' PREVIEW='Important: You must answer all questions and click &quot;next&quot; within 20 minutes to submit your responses. Otherwise, your session will expire and you will have to sign in again and retake the self-assessment.'--><%=fPhra(000299)%></font>
          <!--webbot bot='PurpleText' PREVIEW='Good luck!'--><%=fPhra(000142)%><br>&nbsp;</p>
        </td>
      </tr>
      <%  
        vFormOK = False
      ...
      <tr>
        <td colspan="2" align="center">        
          <% If Not vFormOK Then%>
            <h5 align="center">
            <!--webbot bot='PurpleText' PREVIEW='Error: there are no questions on file for this module!'--><%=fPhra(000300)%></h5>
          <% End If %>
          ...
          <h1 align="center"><!--webbot bot='PurpleText' PREVIEW='Click on the X to close this window.'--><%=fPhra(000103)%></h1>
          <% End If %>
