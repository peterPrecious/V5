...
<html>
  ...
  <title><!--webbot bot='PurpleText' PREVIEW='Description'--><%=fPhra(000118)%></title>
  </head>
  ...
  <table border="0" cellspacing="0" width="100%">
    <tr>
      ...
      <!--webbot bot='PurpleText' PREVIEW='You correctly answered'--><%=fPhra(000027)%> <%=FormatPercent(vMark,1)%>
      <!--webbot bot='PurpleText' PREVIEW='of the questions.'--><%=fPhra(000332)%></h6>
      <h6 align="center">
      <!--webbot bot='PurpleText' PREVIEW='You require 80% for a Certificate of Completion'--><%=fPhra(000017)%>.</h6>
