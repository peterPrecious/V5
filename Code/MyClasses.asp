...
<body style="overflow: hidden;" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" text="#000080" link="#000080" vlink="#000080" alink="#000080">
  ...
  <div id="divDiscuss" style="position: absolute; left:48px; top:39px; width:100%; height:100%;">
    <h1 align="center">The Classroom Manager is coming!<br>What you see below is the Discussion Forum Manager (ignore).</h1>
    <iframe id="iDiscuss" name="iDiscuss" style="width:100%;height:100%;" border="0" frameborder="0" src="<%=vUrl%>" style="background-color: #FFFFFF" scrolling="no" marginwidth="1" marginheight="1"></iframe>
  </div>
