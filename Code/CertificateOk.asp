...
<body link="#000080" vlink="#000080" alink="#000080" bgcolor="#FFFFFF" text="#000080">
  ...
  <table border="0" width="100%">
    <tr>
      ...
      <!--webbot bot='PurpleText' PREVIEW='Congratulations!'--><%=fPhra(000108)%></h1><h2>
      <!--webbot bot='PurpleText' PREVIEW='Your Certificate, which is now displayed in a separate window,<br>can be printed by pressing &lt;Ctrl&gt;+P simultaneously.'--><%=fPhra(000054)%></h2>
