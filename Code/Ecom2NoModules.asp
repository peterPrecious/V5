...
<head>
  ...
  <table border="0" width="100%" cellpadding="3" style="border-collapse: collapse">
    <tr>
      ...
      <td align="center">
      <h2><b><!--webbot bot='PurpleText' PREVIEW='My Learning Modules'--><%=fPhra(000184)%></b></h2> <h6 align="center"><!--webbot bot='PurpleText' PREVIEW='There are no modules available. '--><%=fPhra(000001)%></h6>
      </td>
    </tr>
  </table>
