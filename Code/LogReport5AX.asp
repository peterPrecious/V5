...
'   End If  
  ...
  Sub sExcelInit
    ...
    oCell(vRow, 06) = fPhraH(000232)         : oCell(vRow, 06).Format.Font.Bold = True : oCell.ColumnWidth(06) = 12
    oCell(vRow, 07) = fPhraH(000173)          : oCell(vRow, 07).Format.Font.Bold = True : oCell.ColumnWidth(07) = 16
