...
' vSql = "Seconds expired: " & DateDiff("s", vStrTime, Now) : sDebug
  ...
  Sub sExcelInit
    ...
    oCell(vRow, 07) = "<!--{{-->Module/Assessment<!--}}-->" : oCell(vRow, 07).Format.Font.Bold = True : oCell.ColumnWidth(07) = 12
    oCell(vRow, 08) = "<!--{{-->Title<!--}}-->"             : oCell(vRow, 08).Format.Font.Bold = True : oCell.ColumnWidth(08) = 48
    oCell(vRow, 09) = "<!--{{-->Time Spent<!--}}-->"        : oCell(vRow, 09).Format.Font.Bold = True : oCell.ColumnWidth(09) = 12    
    ...
    oCell(vRow, 12) = "<!--{{-->Best Date<!--}}-->"         : oCell(vRow, 12).Format.Font.Bold = True : oCell.ColumnWidth(12) = 12
