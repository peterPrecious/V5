...
'   oCell(vRow, 05).Style = oStyleR
    ...
    oCell(vRow, 01) = "<!--{{-->Group<!--}}-->"             : oCell(vRow, 01).Format.Font.Bold = True : oCell.ColumnWidth(01) = 16
    ...
    oCell(vRow, 04) = fIf(svCustPwd, "<!--{{-->Learner Id<!--}}-->", "<!--{{-->Password<!--}}-->")                  
                                                              oCell(vRow, 04).Format.Font.Bold = True : oCell.ColumnWidth(04) = 16
    oCell(vRow, 05) = "<!--{{-->Active?<!--}}-->"           : oCell(vRow, 05).Format.Font.Bold = True : oCell.ColumnWidth(05) = 16
    oCell(vRow, 06) = "<!--{{-->Module<!--}}-->"            : oCell(vRow, 06).Format.Font.Bold = True : oCell.ColumnWidth(06) = 16    
    oCell(vRow, 07) = "<!--{{-->Title<!--}}-->"             : oCell(vRow, 07).Format.Font.Bold = True : oCell.ColumnWidth(07) = 40
    oCell(vRow, 08) = "<!--{{-->Time Spent<!--}}-->"        : oCell(vRow, 08).Format.Font.Bold = True : oCell.ColumnWidth(08) = 16
    oCell(vRow, 09) = "<!--{{-->Score<!--}}-->"             : oCell(vRow, 09).Format.Font.Bold = True : oCell.ColumnWidth(09) = 16
    oCell(vRow, 10) = "<!--{{-->Date<!--}}-->"              : oCell(vRow, 10).Format.Font.Bold = True : oCell.ColumnWidth(10) = 16
    oCell(vRow, 11) = "<!--{{-->Memo<!--}}-->"              : oCell(vRow, 11).Format.Font.Bold = True : oCell.ColumnWidth(11) = 16
