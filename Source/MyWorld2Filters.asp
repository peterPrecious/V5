...
'       Response.Write "<br>TskH_No: " & vTskH_No
  ...
  %>
    <tr>
      <td colspan="10"style="text-align:center">&nbsp;<p><a href="MyWorld2.asp?vTskH_Id=<%=vTskH_Id%>">My Learning</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="TaskEdit1.asp">Task Library</a><br>&nbsp;</p>
      </td>
    </tr>
  </table>
