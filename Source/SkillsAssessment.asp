...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="SkillsAssessment.asp" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1" language="JavaScript">
      ...
      <tr>
        ...
        <div align="center">
          ...
          <% If Len(Request("vTskH_Id")) > 0 Then %> <br><br><a href="MyWorld.asp?vTskH_Id=<%=Request("vTskH_Id")%>"><img border="0" src="../Images/Icons/World.gif" alt="<%=Server.HtmlEncode("<!--[[-->Return to My Learning<!--]]-->")%>"></a> <% End If %> <br><br><a href="javascript:history.back(1)"><img border="0" src="../Images/Buttons/Return_<%=svLang%>.gif"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input border="0" src="../Images/Buttons/Update_<%=svLang%>.gif" name="I4" type="image"><br><br><br><a href="SkillsGapAnalysis.asp">Skill Gap Analysis </a><br>&nbsp;</div>
        </td>
      </tr>
    </form>
  </table>
