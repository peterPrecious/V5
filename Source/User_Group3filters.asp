  ...
  <form name="FrontPage_Form1" method="POST" action="User<%=fGroup%>.asp" target="_self" onsubmit="return Validate(this)">
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="3" bordercolor="#DDEEF9" style="border-collapse: collapse">
      <tr>
        ...
        <h6 align="left">
        <!--[[-->Note: This account is limited to ^0 active or inactive learners.&nbsp; Once you reach the maximum you will be unable to add new learners or edit existing learners.&nbsp; You currently have ^1 learners on file.<!--]]--></h6>
        <% End If %> 
      ...
      <tr>
        ...
        <th align="right" width="25%" valign="top"><%=fIf(svCustPwd, "<!--{{-->Id<!--}}-->", "<!--{{-->Password<!--}}-->")%> :</th>
        ...
        <td width="75%" valign="top">
          ...
          <% Else %>
            ...
            <% = fIf (svMembLevel = 5, f10 & "(Learner No : " & vMemb_No & ")", "") %>
            <br><!--[[-->Must be unique using only English alpha, numeric and &quot;_.-@&quot; characters.<!--]]-->
      ...
      <tr>
        ...
        <!--[[-->Password<!--]]--> :</th>
        <td width="75%" valign="top">
          <input type="text" size="30" name="vMemb_Pwd" value="<%=vMemb_Pwd%>" maxlength="64" class="c2"><br><!--[[-->Assigned by learner using only English alpha, numeric and &quot;_.-@&quot; characters.<!--]]-->
      ...
      <tr>
        ...
        <td width="75%" valign="top">
          ...
          <!--[[-->Allows or disallows learner access to this service.<!--]]-->&nbsp;
          <!--[[-->To inactive Facilitators or Managers reset learner level to Learner as well.<!--]]-->
        </td>
      </tr>
      ...
      <tr>
        ...
        <!--[[-->Learner Level<!--]]--> :</th>
        <td width="75%" valign="top">
          <input type="radio" name="vMemb_Level" value="2" <%=fcheck(2, vmemb_level)%>>2: <!--[[-->Learner<!--]]--> (<!--[[-->can access content and assessments<!--]]-->)<br>
          <input type="radio" name="vMemb_Level" value="3" <%=fcheck(3, vmemb_level)%>>3: <!--[[-->Facilitator<!--]]--> (<!--[[-->can add members and monitor progress<!--]]-->)<br>
          <% If svMembLevel > 3 Then %>
      ...
      <tr>
        ...
        <th align="right" width="25%" valign="top">
          <% = fIf(vMemb_Sponsor > 0, "<!--[[-->Sponsor<!--]]-->", "<!--[[-->Sponsored Learners<!--]]-->") %>
        </th>
      ...
      <tr>
        ...
        <br>
          ...
          <% If svCustAcctId <> fDefault(vMemb_AcctId, svCustAcctId) Then %>
             <h5><br><br><!--[[-->Learner Profiles accessed from another Account are Read Only.<!--]]--><br><!--[[-->You cannot Update or Delete this Learner's Profile<!--]]-->.<br></h5>
          <% Else %>     


          <%   If ((svMembLevel = 4 And vCust_DeleteLearners And vCust_MaxUsers = 0) Or svMembManager Or svMembLevel = 5) Then %><%=f5%>
                 <%=f5%><input onclick="jconfirm('User<%=fGroup%>.asp?vDelete=<%=vMemb_No%>&vNext=<%=Server.UrlEncode(vNext)%>','<!--[[-->Ok to delete?<!--]]-->')" type="button" value="<%=bDelete%>" name="bDelete" class="button085"><%=f5%>
          <%   End If %>  
          ...
          <h2><a href="Users_o.asp?vSort=id&vStart=<%=vMemb_Id%>&vLastValue=<%=vMemb_LastName & vMemb_FirstName & vMemb_No%>"><!--[[-->Learner Report<!--]]--></a></h2>
