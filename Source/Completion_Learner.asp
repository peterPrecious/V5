...
<%
  ...
  If Request.Form("bDelete").Count = 1 Then
    ...
    vMemb_No = 0
    vMemb_Criteria = "0"
    vMessage = "<!--{{-->Learner was deleted successfully!<!--}}-->"        
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>
          ...
          <input type="radio" name="vMemb_Active" value="1" <%=fcheck(1, fsqlboolean(vmemb_active))%>><!--[[-->Yes<!--]]-->
        </td>
      </tr>
      ...
      <tr>
        <th><!--[[-->Additional Learning Programs<!--]]-->:</th>
        <td>
          <!--[[-->Note Job Streams in <span style="font-weight:bold" class="red">Red</span> are currently Inactive.<!--]]--><br />
          ...
          <!--[[-->Do not include &quot;No Additional Learning&quot; with other Programs.<!--]]-->
        </td>
      </tr>


      <tr>
        <th><!--[[-->Extend Report Card Access Rights<!--]]-->:<br>&nbsp;</th>
        <td>
          <select name="vMemb_Memo" size="1" multiple style="width: 400px; height: 200px">
            <option <%=fIf(Len(vMemb_Memo) = 0, "selected", "") %> value="XXXX"><!--[[-->No Extended Rights<!--]]--></option>
            <%=fL0s (vMemb_Memo)%>
          </select><br>
          <!--[[-->Do not include &quot;No Extended Rights&quot; with other Rights.<!--]]-->
        </td>
      </tr>
      ...
      <tr>
        <td style="text-align:center" colspan="2">&nbsp;<br><br>
          ...
          <table style="width:600px; text-align:center; margin:auto;">
            <tr>
              <td>
                <h2><a href="Completion_Learners.asp"><!--[[-->Learner Report<!--]]--></a></h2>
              </td>
              <% If vMemb_No > 0 Then %>
              <td>
                <h2><a href="Completion_Learner.asp?vMemb_No=0"><!--[[-->Add a Learner<!--]]--></a></h2>
              </td>
              <%   If Session("Completion_Level") > 3 Then %>
              <td>
                <h2><a href="Completion_LocationManager.asp?vMemb_No=<%=vMemb_No%>"><!--[[-->Change Learner's Location<!--]]--></a></h2>
              </td>
              <%   End If %>
              <% End If %>
            </tr>
