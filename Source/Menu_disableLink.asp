        ...
        <table border="0" cellpadding="5" id="table3" style="width:100%;">
          ...
          <tr>
            ...
            <table cellpadding="2" width="100%" border="0" bordercolor="#FFFFFF">
              ...
              <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                <td>&nbsp; <a <%=fstatx%> href="ProgramsAssigned.asp"><!--[[-->Programs Purchased and Assigned<!--]]--></a></td>
                <td align="left">&nbsp;</td>
              </tr>


              <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                <td>&nbsp; <a <%=fstatx%> target="_blank" href="/Gold/vuClientReporting/ReportViewerFrame.aspx?AccountID=<%=svCustAcctId%>&reportfile=App_Data/repLearnerCompletion.frx"><!--[[-->Completion Status Report - Online Version<!--]]--></a></td>
              ...
              <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                ...
                <div style="text-align: left; margin-left:20px" id="div_R1" class="div">
                  <table border="0" id="table3" cellpadding="10" style="border-collapse: collapse" bordercolor="#DDEEF9" bgcolor="#FFFFFF">
                    <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                      <td><!--[[-->Lists completions/incompletions for all<br />programs assigned to your Learners.<!--]]--></td>
                    </tr>
                  </table>
                </div>
                </th>
              ...
              <tr>
                <td>&nbsp; <!--[[-->Completion Status Report - CSV Download<!--]]--></td>
              ...
              <tr>
                ...
                <div style="text-align: left; margin-left:20px" id="div_R2" class="div">
                  <table border="0" id="table3" cellpadding="10" style="border-collapse: collapse" bordercolor="#DDEEF9" bgcolor="#FFFFFF">
                    <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                      <td><!--[[-->Creates a CSV file of completions/incompletions<br />for all programs assigned to your Learners<!--]]--></td>
                    </tr>
                  </table>
                </div>
                </th>
              ...
              <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                <td>&nbsp; <a <%=fstatx%> target="_blank" href="/Gold/vuclientreporting/ReportExport.aspx?AccountID=<%=svCustAcctId%>&reportfile=repLearnerIncompleteCourseExport.frx&type=CSV"><!--[[-->InCompletion Report - CSV Download<!--]]--></a> </td>
              ...
              <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                ...
                <div style="text-align: left; margin-left:20px" id="div_R3" class="div">
                  <table border="0" id="table3" cellpadding="10" style="border-collapse: collapse" bordercolor="#DDEEF9" bgcolor="#FFFFFF">
                    <tr onmouseover="this.className='bgOn'" onmouseout="this.className='bgOff'">
                      <td style="text-align: left; margin-left: 10px"><!--[[-->Creates a CSV file of programs that have not been completed<br />for all programs assigned to your Learners<!--]]--></td>
                    </tr>
                  </table>
                </div>
                </th>
