...
<%
  ...
  sEmailAlert vEmail_Notify, vEmail_Subject, vEmail_Note, "<!--{{-->Items of interest<!--}}-->"
...
%>
  ...
  <table border="1" width="100%" bordercolor="#DDEEF9" style="border-collapse: collapse" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <!--[[-->Your email alerts were sent successfully<!--]]-->.<br><br>&nbsp;
      <!--[[-->Remember to sign off if you are finished<!--]]-->.<br>&nbsp; </td>
    </tr>
  </table>
