...
<%
  ...
  If Len(Trim(svMembFirstName & " " & svMembLastName)) = 0 Then
    Response.Redirect "Error.asp?vErr=" & Server.UrlEncode("<!--{{-->You cannot use the email alert feature unless your are setup with a first and/or last name.<!--}}-->")
  End If
  ...
  <form name="SelectMembers" method="POST" action="EmailAlertOK.asp">
    ...
    <table border="1" width="100%" bordercolor="#DDEEF9" style="border-collapse: collapse" cellpadding="3" cellspacing="0">
      <tr>
        ...
        <h2 align="left">
        <!--[[-->This allows you to send an email to the learner(s) selected below.&nbsp; The preformatted note will include a link to this site, a reference to the current task plus any additional message that you enter below.<!--]]--></h2>
        </td>
      </tr>
      ...
      <tr>
        ...
        <!--[[-->Please allow a few minutes to send email(s)<!--]]-->.<br>&nbsp;</td>
      </tr>
    </table>
  </form>
