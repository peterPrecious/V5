...
' sDebug
  ...
  If oRsCheck.Eof Then
    vMsg = "<!--{{-->Your scores for this exam have not yet been posted.<!--}}-->"    
  Else
...
'   sDebug "vPassGrade", vPassGrade
    If  vGrade < vPassGrade Then
      vMsg = "<!--{{-->Because you did not pass this exam, no certificate can be produced.<!--}}-->"    
    End If
  End If
  oRsCheck.Close
...
%>
    ...
    <table border="1" wIdth="100%" bordercolor="#DDEEF9" style="border-collapse: collapse" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <!--[[-->This Certificate may now be printed by pressing &lt;Ctrl&gt;+P simultaneously.<!--]]-->
