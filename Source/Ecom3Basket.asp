...
<!--          <script>jTitle("/*--{[--*/My Basket/*--]}--*/", 'Basket.jpg')</script>-->
          <img src="../Images/Ecom/MyBasket_<%=svLang %>.png" />
        </div>
        <h1><!--[[-->My Basket<!--]]--></h1>
        <p class="c2"><!--[[-->You have chosen to register for the following programs.&nbsp; Multi-learner discounts apply and will be calculated/shown after the number of seats is entered.<!--]]--></p>
        <a href="javascript:toggle('div_discounts');" class="c3"><!--[[-->Show Multi-learner Discounts<!--]]--></a>
        <div id="div_discounts" class="div">
          <table style="width: 60%; margin: auto;">
            <tr>
              <td style="text-align: center" height="30" bgcolor="#DDEEF9">
                <p><!--[[-->The following multi-learner discounts apply.<!--]]-->
                </p>
              </td>
            </tr>
            <tr>
              <td style="text-align: center">
                <table border="0" id="table8" bordercolor="#DDEEF9" cellpadding="0">
                  <tr>
                    <th nowrap style="text-align: center" colspan="3">
                      <!--[[-->Total Seats<!--]]-->&nbsp;&nbsp; </th>
                    <th nowrap style="text-align: center">&nbsp;<!--[[-->Discount<!--]]--></th>
                  </tr>
                  <tr>
                ...
                <br />
                <div class="red"><a class="red" href="mailto:<%=fDefault(vCust_Email, "info@vubiz.com")%>?subject=Multi User License Enquiry"><b><!--[[-->Email us<!--]]--></a> <!--[[-->if you are interested in more seats.<!--]]--></div>
        ...
        <h3 style="margin-bottom: 10px;"><!--[[-->Please enter the number of seats you wish to assign to each Program.<!--]]--></h3>
      </td>
    </tr>
  </table>
  <table class="table">
    ...
    %>
    <tr>
      <th class="rowshade" rowspan="2" style="width: 15%; text-align: left"><!--[[-->Program<!--]]--></th>
      <th class="rowshade" rowspan="2" style="width: 50%; text-align: left"><!--[[-->Program Title<!--]]--></th>
      <th class="rowshade" rowspan="2" style="width: 15%; text-align:center;"><!--[[-->No. of <br>Seats<!--]]--></th>
      <th class="rowshade" colspan="2" style="width: 20%; text-align:center;">&nbsp;&nbsp;<!--[[-->Per Seat Cost<!--]]--> *</th>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5" style="text-align: center;">
        <h6><br><br>
          <!--[[-->No items have been selected, please click <b>Return</b>.<!--]]--><br><br>
    ...
    <tr>
      <td colspan="5" style="text-align: center;"><br />
        ...
        <table class="table" style="width:50%; margin:auto;">
          <tr>
            <td style="text-align: center">
              <input type="button" onclick="location.href = '<%=vPage%>'" value="<%=bReturn%>" name="bReturn" id="bReturn" class="button"><br><!--[[-->to Catalogue<!--]]-->
            </td>
            <td style="text-align: center">
              <input type="button" onclick="location.href = 'Ecom3Basket.asp?vAction=Clear&vPage=<%=vPage%>'" value="<%=bClear%>" name="bClear" class="button"><br><!--[[-->my Basket<!--]]-->
            </td>
            <td style="text-align: center">
              <input type="button" onclick="top.main.location.href = 'Ecom2Customer.asp'" value="<%=bContinue%>" name="bContinue" class="button"><br><!--[[-->with Purchase<!--]]-->
            </td>
          </tr>
        </table>

        <h3>* 
          <!--[[-->Applicable taxes extra for Canadian orders.&nbsp; <br>Products purchases outside Canada are payable in US funds.<!--]]-->&nbsp;&nbsp;  
          <!--[[-->This transaction will be processed through a Canadian financial institution. Please refer to your credit card agreement regarding fees, if any.<!--]]-->
        </h3>
      </td>
    </tr>
    <% 
