...
<body>
  ...
  <div style="text-align: center">
    ...
    <div style="text-align: center">
      ...
      <a href="MyWorld.asp?vTskH_AcctId=<%=vTskH_AcctId%>&vTskH_Id=<%=vTskH_Id%>&vToggle=999"><!--[[-->Expand All Nodes<!--]]--></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      <% End If %>

      <a href="MyWorld.asp?vTskH_AcctId=<%=vTskH_AcctId%>&vTskH_Id=<%=vTskH_Id%>&vToggle=998"><!--[[-->Collapse All Nodes<!--]]--></a>
