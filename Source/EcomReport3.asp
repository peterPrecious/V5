...
<head>
  ...
  <title>Program Sales Report</title>
</head>
...
<body>
  ...
  <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#DDEEF9" width="600">
    <tr>
      ...
      <table border="0" cellspacing="0" cellpadding="5" style="border-collapse: collapse" bordercolor="#111111" width="523">
        <form method="POST" action="EcomReport3.asp">
          <input type="Hidden" name="vHidden" value="Hidden">
          <tr>
            <th align="right" valign="top" width="30%" nowrap>Select Start Date :</th>
            <td width="68%" nowrap><input type="text" name="vStrDate" size=" 8" value="<%=vStrDate%>" class="c2"> <a title="<!--[[-->Start at the beginning...<!--]]-->" class="debug" onclick="fillField('vStrDate', 'Jan 1, 2000')" href="#">&#937;</a><span style="background-color: #FFFF00"><%=vStrDateErr%></span><br>ie Jan 1, 2010 (MMM DD, YYYY). <br>Leave empty to start at first sale.</td>
          </tr>
          <tr>
            <th align="right" valign="top" width="30%" nowrap>Select End Date :</th>
            <td width="68%" nowrap><input type="text" name="vEndDate" size="8" value="<%=vEndDate%>" class="c2"> <a title="<!--[[-->Start at the beginning...<!--]]-->" class="debug" onclick="fillField('vStrDate', 'Jan 1, 2000')" href="#">&#937;</a><span style="background-color: #FFFF00"><%=vEndDateErr%></span><br>ie Mar 31, 2010 (MMM DD, YYYY). <br>Leave empty to finish with last sale.</td>
          </tr>
          <%
...
<!--
          <tr>
            ...
            <td align="left" width="68%" nowrap>
              <input type="radio" value="y" name="vDetails" checked>Yes - <font color="#FF0000"><b>this should only used for montly reporting<br></b></font><input type="radio" value="n" name="vDetails">No, summary only - <font color="#FF0000"><b>this should only used for montly reporting</b></font><p><font color="#FF0000">NOTE: if you wish to select a time frame more than a month or two, <br>
              ensure you either use Online Summary or Excel Details</font></td>
          </tr>
-->
          <tr>
            <th align="right" valign="top" width="30%" nowrap>Then click either :</th>
            <td align="left" width="68%" nowrap><input type="submit" value="Online Summary" name="bOnline" id="bPrint" class="button">&nbsp;&nbsp; or ...&nbsp; <input type="submit" value="Excel Details" name="bExcel" class="button"><p>&nbsp;Note: MS Excel always shows details.</td>
          </tr>
        </form>
      </table>
      </td>
...
vOk = True
    ...
    <tr>
      <th align="left" colspan="10" height="30" nowrap># Programs Sold</th>
      <th align="right" height="30"><%=vProgsSold%> </th>
    </tr>
    <tr>
      <th align="left" colspan="10" height="30" nowrap># Programs Refunded</th>
      <th align="right" height="30"><%=vProgsRefs%> </th>
    </tr>
    <tr>
      <th align="left" colspan="10" height="30" nowrap># Programs Total</th>
