      ...
      <table cellpadding="10" style="border-collapse: collapse" border="1" bordercolor="#FF0000" width="100%">
        <tr>
          <td class="c5" align="center">
            <!--[[-->Your session will expire in<!--]]--> <span id="dTimeRemaining"></span>.<br><br>
            <!--[[-->If you need more time click here.<!--]]--><br><br>
      ...
      <table cellpadding="10" style="border-collapse: collapse" border="1" bordercolor="#FF0000" width="100%">
        <tr>
          <td class="c5" align="center">
            ...
            <!--[[-->Please sign-into this service again to resume your learning.<!--]]-->
          </td>
        </tr>
      </table>
    </div>
