...
<body>
  ...
  <div>
    ...
    <h2><!--[[-->Learning Completion Rates for<!--]]--><br><!--[[-->^1 : ^2<!--]]--></h2>
  </div>
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    ...
    <tr>
      ...
      <td class="rowshade" style="width:200px; text-align:left;"><a href="Completion_5.asp?vOrder=Name"><!--[[-->Name<!--]]--></a></td>
      <td class="rowshade" style="width:100px; text-align:center;"><!--[[-->Role<!--]]--> </td>
      <td class="rowshade" style="width:100px; text-align:center;"><!--[[-->Complete %<!--]]--></td>
    </tr>
...
'            & "   ((vRept.RepS_BestDate BETWEEN '" & DateAdd("d", -1, Session("Completion_StrDate")) & "' AND '" & DateAdd("d", 1, Session("Completion_EndDate")) & "') OR RepS_BestDate IS NULL) "_
      ...
      <tr>
        <th colspan="4"><!--[[-->^1 Total Completed<!--]]--> :</th>
      ...
      <td colspan="5" style="text-align:center;">
        ...
        <br><br>
        <% p1 = Session("Completion_L0tit") %>
        <!--[[-->^1 Total Completed is the percentage of selected assessments completed.<!--]]--><br>
