...
'   If Session("Completion_Level") > 4 Or Len(vMemb_Memo) > 8 Then
  ...
  Else  
    ...
    Select Case Session("Completion_Active")
    	Case "Y"  : Session("Completion_ActiveD") = "<!--{{-->Yes<!--}}-->"
      Case "N"  : Session("Completion_ActiveD") = "<!--{{-->No<!--}}-->"
      Case Else : Session("Completion_ActiveD") = "<!--{{-->All<!--}}-->"
    End Select

    Session("Completion_Completed") = fDefault(Ucase(Request("vCompleted")), "X")
    Select Case Session("Completion_Completed")
    	Case "Y"  : Session("Completion_CompletedD") = "<!--{{-->Yes<!--}}-->"
      Case "N"  : Session("Completion_CompletedD") = "<!--{{-->No<!--}}-->"
      Case Else : Session("Completion_CompletedD") = "<!--{{-->All<!--}}-->"
    End Select
...
<head>
  ...
  <script>	
   ...
   function Validate(theForm) {
      var message_01 = "/*--{[--*/Please select one or more Roles./*--]}--*/"
      var message_02 = "/*--{[--*/Please select one or more Programs./*--]}--*/"
      var isChecked = false
...
<body>
  ...
  <% Server.Execute vShellHi %>
    ...
    <div>
      ...
      <h2><!--[[-->Selecting multiple Roles and multiple Programs will require several minutes of processing.<!--]]--></h2>
      <h2><!--[[-->Learning Completion Rates<!--]]--> - <!--[[-->Selection Criteria<!--]]--><br><!--[[-->For all Active Learners<!--]]--></h2>
    </div>
      ...
      <table class="table">
        <tr>
          ...
          <td>          
            ...
            %>
            <br>
            <input type="checkbox" name="checkRoles" onclick="checkOnOff(this, 'vRole');" value="on" <%=fCheck("on", Session("Completion_checkRoles"))%>><!--[[-->Select All/None<!--]]-->           
          </td>
        </tr>

        <tr>
          <th><!--[[-->Programs | Modules<!--]]--> :</th>
          <td>
          <%
...
<%            
          ...
          <br>
          <input type="checkbox" name="checkProgs" onclick="checkOnOff(this, 'vProg');" value="on" <%=fCheck("on", Session("Completion_checkProgs"))%>><!--[[-->Select All/None<!--]]--><br><br>
          <!--[[-->Click Program Title to refine Selection.<!--]]--><br>
          <!--[[-->Report will show all selected Modules<!--]]--></td>
        ...
        <tr>
          ...
          <td>
          	<input type="radio" value="Y" name="vCompleted" <%=fchecks(session("Completion_completed"), "y")%>><!--[[-->Yes<!--]]--> 
          	<input type="radio" value="N" name="vCompleted" <%=fchecks(session("Completion_completed"), "n")%>><!--[[-->No<!--]]--> 
          	<input type="radio" value="X" name="vCompleted" <%=fchecks(session("Completion_completed"), "x")%>><!--[[-->All<!--]]--> 
         </td>
        </tr>
        <%
            end if
        ...
        %>
        <tr>
          <th><!--[[-->Completed on or after<!--]]--> :</th>
          <td>
            <input type="text" name="vStrDate" size="13" value="<%=Session("Completion_StrDate")%>"> <!--[[-->Use English Date format<!--]]-->.&nbsp; <!--[[-->Defaults to Jan 01, 2000.<!--]]-->
          </td>
        </tr>
        <tr>
          <th><!--[[-->Completed on or before<!--]]--> :</th>
          <td>
            <input type="text" name="vEndDate" size="13" value="<%=Session("Completion_EndDate")%>"> <!--[[-->Use English Date format<!--]]-->.&nbsp; <!--[[-->Defaults to today, ^1.<!--]]-->
          </td>
        </tr>
