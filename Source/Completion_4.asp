...
<body>
  ...
  <div>
    ...
    <h2><!--[[-->Learning Completion Rates for<!--]]--><br><%=Session("Completion_L1tit")%>&nbsp;<%=Session("Completion_L1val") & " : " & fL1Title (Session("Completion_L1val"))%></h2>
  </div>

  <table class="table">
    <tr>
      <th style="width:50%"><!--[[-->Roles<!--]]--> :</t>
      <td style="width:50%" class="c3">
        <% 
          ...
          Else
        %>
        <a onclick="toggle('divRoles')" href="#"><!--[[-->Click here<!--]]--></a><div class="div" id="divRoles"><table class="table"><tr><td><%=Session("Completion_RoleD")%></td></tr></table></div>
        <% 
          End If 
        %>              
      </td>
    ...
    <tr>
      ...
      <td style="width:50%">
        <% 
          ...
          Else
        %>
        <a onclick="toggle('divModules')" href="#" class="c3"><!--[[-->Click here<!--]]--></a>
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    ...
    <tr>
      ...
      <td class="rowshade" style="width:100px; text-align:left;"><a href="Completion_4.asp?vOrder=Name"><!--[[-->Title<!--]]--></a></td>
...
'            & "   ((vRept.RepS_BestDate BETWEEN '" & DateAdd("d", -1, Session("Completion_StrDate")) & "' AND '" & DateAdd("d", 1, Session("Completion_EndDate")) & "') OR RepS_BestDate IS NULL) "_
    ...
    <tr>
      <th colspan="3"><%=fPhraId(Session("Completion_L1tit"))%> <!--[[-->Total Completed<!--]]--> :</th>
    ...
    <tr>
      <td colspan="4" style="text-align:center;">
        ...
        <br><br>
        <%=fPhraId(Session("Completion_L1tit"))%>&nbsp;<!--[[-->Total Completed is the percentage of selected assessments completed.<!--]]--><br>
      <%
