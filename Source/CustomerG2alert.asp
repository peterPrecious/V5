  ...
  <table border="0" width="100%" bordercolor="#DDEEF9" style="border-collapse: collapse" cellpadding="10">
    <form method="POST" action="CustomerG2Alert.asp" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1">
      ...
      <tr>
        ...
        <!--[[-->Include Email Alerts<!--]]--> : </th>
        <td width="50%">
          <input class="c2" type="radio" value="1" <%=fCheck(fSqlBoolean(vCust_EcomG2alert), 1)%> name="vCust_EcomG2alert"><!--[[-->Yes<!--]]-->&nbsp;&nbsp; 
          <input class="c2" type="radio" value="0" <%=fCheck(fSqlBoolean(vCust_EcomG2alert), 0)%> name="vCust_EcomG2alert"><!--[[-->No<!--]]-->&nbsp; </td>
      </tr>
      <tr>
