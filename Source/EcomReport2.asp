  ...
  <form method="POST" action="EcomReport2.asp">
    ...
    <table border="1" width="100%" cellpadding="5" cellspacing="0" bordercolor="#DDEEF9" style="border-collapse: collapse">
      ...
      <tr>
        ...
        <td width="70%"><input type="text" name="vStrDate" size="11" value="<%=vStrDate%>"> <a title="<!--[[-->Empty field<!--]]-->" class="debug" onclick="emptyField('vStrDate')" href="#">&#937;</a>&nbsp; ie Jan 1, 2005 (mmm d, yyyy). </td>
      </tr>
      <tr>
        <th align="right" valign="top" width="30%">Select End Date :</th>
        <td width="70%"><input type="text" name="vEndDate" size="11" value="<%=vEndDate%>"> <a title="<!--[[-->Empty field<!--]]-->" class="debug" onclick="emptyField('vEndDate')" href="#">&#937;</a>&nbsp; ie Mar 31, 2005 (mmm d, yyyy).</td>
      </tr>
      <tr>
