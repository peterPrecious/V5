...
<!--              <script>jTitle("/*--{[--*/Multiple Learner License/*--]}--*/", 'MultiLicense.jpg')</script>-->
        ...
        <!--[[-->To purchase a program, click the <b>Add</b> button and the program will be added to your basket and removed from this list.&nbsp; Click <b>Return</b> to come back to this list to add more programs.<!--]]-->&nbsp;<!--[[-->Click on the program title to view the program/module description.<!--]]-->
        </p>
        ...
        <p class="c6"><% If vCust_EcomDiscOptions > 0 Then %><!--[[-->Note: any applicable discounts will be calculated and displayed in your basket.<!--]]--><% End If %> </p>
  ...
  <table class="table">
    ...
    <tr>
      <th class="rowshade" style="text-align:left; width:40%;"><!--[[-->Program Title<!--]]--></th>
      <th class="rowshade"><!--[[-->Duration Days<!--]]--></th>
      <td class="rowshade" style="text-align:center" colspan="2">
        <table class="table">
          <tr><th class="rowshade" colspan="2">&ensp;<!--[[-->Per Seat Cost<!--]]--> *&ensp;</th></tr>
          <tr><th class="rowshade">USA$</th><th class="rowshade">CAN$</th></tr>
        </table>
      </td>
      <th class="rowshade" style="text-align:center;"" ><!--[[-->Add to Basket<!--]]--></th>
    </tr>
  ...
  <br /><br />
  <% If vCnt = 0 Then %>
  <h6><!--[[-->There are no programs available for purchase in the category<!--]]--> <b><%=vCatl_Title%></b>.&nbsp;<!--[[-->Previously purchased programs can be accessed by clicking on the &quot;My Content&quot; tab above.&nbsp; If you have just selected them, they can be accessed by clicking on <b>Show My Basket</b> link.<!--]]--></h6>
  <% Else %> 
  <h3><!--[[-->Click on the program title to view the program/module description.<!--]]--></h3> 
  <h3><a <%=fstatx%> href="Ecom2Basket.asp?vPage=Ecom2Programs.asp" class="c3"><!--[[-->Show My Basket<!--]]--></a></h3>
  <h3>* <!--[[-->Applicable taxes extra for Canadian orders.&nbsp; <br>Products purchases outside Canada are payable in US funds.<!--]]--></h3>
  <% End If %>
