...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="CatlEdit.asp" target="_self" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1" language="JavaScript">
  ...
  <%  If vCnt > 0 Then %> 
    ...
    <p align="center"><a <%=fstatx%> href="javascript:jconfirm('CatlEdit.asp?vAction=CC','<%=Server.HtmlEncode("<!--{{-->Ok to clear out catalogue?<!--}}-->")%>')"><img border="0" src="../Images/Buttons/Clear_<%=svLang%>.gif"></a></p>
