...
<%
  ...
  If vEcom_Media = "Group" Then
    vTitle = "<!--{{-->Select the number of Seats / Learners<br>that will be applied to all programs purchased.<!--}}-->"
  ElseIf vEcom_Media = "CDs" Then
    vTitle = "<!--{{-->Available CD Discounts<!--}}-->"
  Else
    vTitle = ""
  End If
...
<!--        <script>jTitle("/*--{[--*/My Basket/*--]}--*/", 'Basket.jpg')</script>-->
        ...
        <h1><!--[[-->My Basket<!--]]--></h1>
        <h2><!--[[-->You have chosen to register for the following programs.<!--]]--></h2>
      </td>
    </tr>
  </table>
  ...
  <table class="table">
    ...
    <tr>
      <td colspan="5" style="text-align: center;">
        ...
        <h3>*
          <!--[[-->Applicable taxes extra for Canadian orders.&nbsp; <br>Products purchases outside Canada are payable in US funds.<!--]]--></h3>
      </td>
    </tr>
