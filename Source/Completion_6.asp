...
<body>
  ...
  <div>
    ...
    <h2>
      <!--[[-->Program Completion Rates<!--]]--> for: <br>
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    ...
    <tr>
      ...
      <th class="rowshade" style="width:150px; text-align:center;"><a href="Completion_6.asp?vOrder=Id&vLearner=<%=Session("Completion_Learner")%>&vName=<%=Session("Completion_Name")%>"><!--[[-->Program<!--]]--></a></th>
      <th class="rowshade" style="width:250px; text-align:left;"><a href="Completion_6.asp?vOrder=Title&vLearner=<%=Session("Completion_Learner")%>&vName=<%=Session("Completion_Name")%>"><!--[[-->Title<!--]]--></a></th>
      <th class="rowshade" style="width:090px; text-align:center;"><!--[[-->Complete %<!--]]--></th>
    </tr>
    <%
    ...
    <tr>
      <th colspan="3"><!--[[-->Program Total Completed<!--]]--> :</th>
    ...
    <tr>
      ...
      <br><br>
      <!--[[-->Program Total Completed is the percentage of selected assessments completed.<!--]]--><br>
      ...
      <form name="fForm">
        ...
        <p><!--[[-->Excel Output contains the raw data used above.<!--]]--></p>
      </form>
      </td>
    </tr>
  </table>
