...
'       fAccess = "<a name='" &  vTskH_Order & "' href='MyWorldRedirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "#" &  vTskH_Order & "'><img border='0' src='../Images/Common/VuPlus.gif'  alt='" & Server.HtmlEncode("<!--{{-->Expand Node<!--}}-->") & "'></a>"
				fAccess = "<a name='" &  vTskH_Order & "' href='MyWorldRedirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "'><img border='0' src='../Images/Common/VuPlus.gif'  alt='" & Server.HtmlEncode("<!--{{-->Expand Node<!--}}-->") & "'></a>"
			Else
'...anchor bug in XP SP2 - removed
'       fAccess = "<a name='" &  vTskH_Order & "' href='MyWorldRedirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "#" &  vTskH_Order & "'><img border='0' src='../Images/Common/VuMinus.gif' alt='" & Server.HtmlEncode("<!--{{-->Collapse Node<!--}}-->") & "'></a>"
				fAccess = "<a name='" &  vTskH_Order & "' href='MyWorldRedirect.asp?vTskH_AcctId=" & vTskH_AcctId & "&vTskH_Id=" & vTskH_Id & "&vToggle=" & vTskH_Order & "'><img border='0' src='../Images/Common/VuMinus.gif' alt='" & Server.HtmlEncode("<!--{{-->Collapse Node<!--}}-->") & "'></a>"
			End If
		End If
	End Function
