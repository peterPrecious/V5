...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="ChannelQuickSetup.asp" target="_self" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1" language="JavaScript">
    ...
    <table border="1" width="100%" style="border-collapse: collapse" bordercolor="#DDEEF9" cellpadding="3" id="table4">
      <tr>
        <td align="center" width="90%" rowspan="3"><h1>Quick Channel Site Setup</h1><h2>To Add a new Channel site, enter a 4 character Customer Id at right.&nbsp; <br>Note: use an existing Id for existing Customers otherwise create a new Id avoiding the letters &quot;IOL&quot;.&nbsp; <br>The next available Customer No (6xxx) will be generated and display below.</h2><h2>Display channel sites by <a <%=fStatX%> href="ChannelQuickSetup.asp?vSort=C">first 4 characters</a>&nbsp; |&nbsp; <a <%=fStatX%> href="ChannelQuickSetup.asp?vSort=N">last 4 numbers</a><br>If the catalogue is selected you can click on the Facilitator or Manger link to <br>access the site as they would see it.</h2></td>
        <th nowrap colspan="2" valign="bottom"><br>&nbsp;<p class="c1">Add a new Channel Site</p></th>
      </tr>
      <tr>
  ...
  <table width="100%" border="1" cellspacing="0" bordercolor="#DDEEF9" cellpadding="0" style="border-collapse: collapse">
    ...
    <tr>
      ...
      <td>
        <a <%=fStatX%> target="_top" href="../Default.asp?vCust=<%=vCust_Id%>&vId=<%=vCust_FacilitatorId%>"><%=vCust_FacilitatorId%></a>
      </td>
        
      <td>
        <a <%=fStatX%> target="_top" href="../Default.asp?vCust=<%=vCust_Id%>&vId=<%=vCust_ManagerId%>"><%=vCust_ManagerId%></a>
      </td>
    </tr>
    <%  
        End If
    ...
    %>
    <tr>
      <td valign="Top" align="center" colspan="7"><br><br><a <%=fStatX%> href="javascript:history.back(1)"><img border="0" src="../Images/Buttons/Return_<%=svLang%>.gif"></a><p><a <%=fStatX%> href="ChannelEdit.asp?vEditCustId=<%=svCustId%>&vHidden=n">Customer Profile</a><br>&nbsp;</p></td>
    </tr>
  </table>
...
<%
  Else  
    ...
    If Request("vAddCustId").Count > 0 Then 
      vCust_Id = Ucase(Request("vAddCustId")) & fNextCustNo (6)
      vFunction = "add"
...
%>
  ...
  <form method="POST" action="ChannelQuickSetup.asp" target="_self" language="JavaScript">
    ...
    <table border="1" width="100%" cellspacing="0" bordercolor="#DDEEF9" style="border-collapse: collapse" cellpadding="3">
      <tr>
        <td align="center" width="100%" valign="Top" colspan="2"><h1>Quick Channel Setup</h1><h2>This allows you to add or edit your channel customers.</h2></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="Top" width="60%"><input type="text" size="46" name="vCust_URL" value="<%=vCust_URL%>"><br>Channel URL accessed when above logo is clicked.&nbsp; Do not preface with &quot;//&quot;.<br>If empty, defaults to &quot;vubiz.com&quot; </td>
      </tr>
      <tr>
        <th align="right" valign="Top" width="30%">Catalogue :</th>
        <td valign="Top" width="60%">
          <% i = fCatlDropdown (vCust_Catalogue, "NORM") %><select size="7" name="vCust_Catalogue" multiple><% = i %></select><br>Catalogue groups can be free &quot;F&quot;, sold via ecommerce &quot;$&quot; or both.<br>Use CTL+Enter to select multiple groups.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" align="center" valign="Top" width="100%"><br><br><a <%=fStatX%> href="javascript:history.back(1)"><img border="0" src="../Images/Buttons/Return_<%=svLang%>.gif"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input border="0" src="../Images/Buttons/Update_<%=svLang%>.gif" name="I4" type="image"> 
          ...
          %>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a <%=fStatX%> href="<%=i%>"><img border="0" src="../Images/Buttons/Delete_<%=svLang%>.gif"></a> 
          <% End If %>
          <h6>Warning, if you delete an existing channel site, history logs will also be deleted.<br>This is an irreversible, non-recoverable action.</h6>
          <p align="center"><a <%=fStatX%> href="ChannelQuickSetup.asp">Customer List</a><br>&nbsp;</p>
        </td>
      </tr>
      </table>
  </form>
