...
<base href="//localhost/v5/Source/LogReport5SX.asp" fptype="TRUE">

<% 
  '...Excel variables
  Dim oWs, oCell, oStyle, vRow, vCol 
  Dim vCookie, vLevel, vId_Pwd, vStrDate, vTitle, vFind, vFindId, vFindFirstName, vFindLastName, vFindEmail, vFindCriteria, vUrl, vResults, aResults, vCriteria, vParmNo, aGroup1, aMemo
...
'   End If  
  ...
  Sub sExcelInit
    ...
    oCell(vRow, 06) = "<!--{{-->Memo<!--}}-->"          : oCell(vRow, 06).Format.Font.Bold = True : oCell.ColumnWidth(06) = 16
    oCell(vRow, 07) = "<!--{{-->Results...<!--}}-->"    : oCell(vRow, 07).Format.Font.Bold = True : oCell.ColumnWidth(07) = 12
