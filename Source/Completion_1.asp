...
<body>
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    <tr>
      <th style="width:50%"><!--[[-->Learning Completion Rates<!--]]--> :</th>
      <td class="c3"  style="width:50%"><!--[[-->National<!--]]--></td>
    </tr>
    <tr>
    ...
    <tr>
      <th style="width:50%"><!--[[-->Programs | Modules<!--]]--> :</th>
      <td class="c3" style="width:50%">
        <% 
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    ...
    <tr>
      ...
      <td class="rowshade" style="width:100px; text-align:left;"><a href="Completion_1.asp?vOrder=Name"><!--[[-->Title<!--]]--></a></td>
      <td class="rowshade" style="width:090px; text-align:center;"><!--[[-->Complete %<!--]]--></td>
    </tr>
    <%
...
'            & "   ((vRept.RepS_BestDate BETWEEN '" & DateAdd("d", -1, Session("Completion_StrDate")) & "' AND '" & DateAdd("d", 1, Session("Completion_EndDate")) & "') OR RepS_BestDate IS NULL) "_
    ...
    <tr>
      <th colspan="3"><%=Session("Completion_L9tit")%> <!--[[-->Total Completed<!--]]--> :</th>
      <th style="text-align:center;"><%=FormatNumber(vYes/vAll*100, 0)%>%</th>
    </tr>
    <tr>
      <th colspan="3"><!--[[-->Number of Learners Included<!--]]-->&nbsp;:</th>
      <th style="text-align:center;"><%=vTotal%>&nbsp; </th>
    </tr>
    <tr>
      <td colspan="4" style="text-align:center;">

      <br><br><%=Session("Completion_L9tit")%>&nbsp;<!--[[-->Total Completed is the percentage of selected assessments completed.<!--]]--><br>
      <%
