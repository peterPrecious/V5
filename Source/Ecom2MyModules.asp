...
<head>
  ...
  <table border="0" width="100%" cellpadding="3" style="border-collapse: collapse">
    <tr>
      ...
      <td align="center">
      <h2 align="left"><!--[[-->Click a module title below to launch the module and start e-learning.&nbsp; If an examination is included in this learning program it will appear below.&nbsp; Click the examination link to access the exam. <!--]]--></h2>
      </td>
    </tr>
  </table>
  ...
  <table cellspacing="0" border="1" id="table3" width="100%" cellpadding="3" bordercolor="#DDEEF9" style="border-collapse: collapse">
    ...
    <tr>
      ...
      <td align="right" nowrap valign="top" <%=vBg%>><p class="c2">
        ...
        &nbsp;&nbsp;[<a <%=fStatX%> href="Ecom2Module.asp?vModsId=<%=vMods_Id%>"><!--[[-->Desc<!--]]--></a>]
        <% End If %>
        ...
        <%
          ...
          [Passed]
          <% Else %>
          &nbsp;&nbsp;[<a <%=fStatX%> href="javascript:<%=vMods_AssessmentScript%>('<%=vMods_AssessmentUrl%>','<%=vMods_Id%>')"><!--[[-->Assessment<!--]]--></a>]
          <% End If %>
        <% End If %>
    ...
    <tr>
      <td width="90%" <%=vBg%> colspan="2"><p class="c1">
        <a <%=fStatX%> href="javascript:assessmentwindow('<%=vProg_Assessment%>')"><!--[[-->Examination<!--]]--></a>
      </td>  
    </tr>
    <%
    ...
    %>
    <tr>
      <td width="90%" <%=vBg%> colspan="2"><p class="c1"><a <%=fStatX%> href="javascript:vuwindow('CertCompletion.asp?vProgId=<%=vProg_Id%>&vClose=Y',650,425,100,100,'no','no','no')"><!--[[-->Certificate of Completion<!--]]--></a></td>
    </tr>
    <%
      End If
    %>
