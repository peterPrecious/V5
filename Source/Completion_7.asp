...
<body>
  ...
  <div>
    ...
    <h2><!--[[-->Module Completion Status of<br>Program<!--]]-->&nbsp;<%=Session("Completion_vProgId") & " : " & Session("Completion_vProgTitle")%> for<br><%=Session("Completion_Learner") & " - " & Session("Completion_Name")%></h2>
  </div>
    ...
    <tr>
      ...
      <td class="c3"">
        <% 
          ...
          Else
        %>
        <a class="c3" onclick="toggle('divRoles')" href="#"><!--[[-->Click here<!--]]--></a><div class="div" id="divRoles"><table class="table"><tr><td><%=Session("Completion_RoleD")%></td></tr></table></div>
        <% 
          End If 
        %>              
      </td>
    ...
    <tr>
      ...
      <td class="c3">
        <% 
          ...
          Else
        %>
        <a class="c3" onclick="toggle('divModules')" href="#"><!--[[-->Click here<!--]]--></a><div class="div" id="divModules"><table class="table"><tr><td><%=Session("Completion_ProgramD")%></td></tr></table></div>
        <% 
          End If 
        %>              
      </td>
  ...
  <table style="width:600px; margin:20px auto 20px auto">
    ...
    <tr>
      ...
      <th class="rowshade"><a href="Completion_7.asp?vOrder=Id&vProgId=<%=Session("Completion_vProgId")%>&vProgTitle=<%=Session("Completion_vProgTitle")%>"><!--[[-->Module<!--]]--></a></th>
      <th class="rowshade"><a href="Completion_7.asp?vOrder=Title&vProgId=<%=Session("Completion_vProgId")%>&vProgTitle=<%=Session("Completion_vProgTitle")%>"><!--[[-->Title<!--]]--></a></th>
      <th class="rowshade"><!--[[-->No<br>Attempts<!--]]--></th>
      <th class="rowshade"><!--[[-->Best<br>Score<!--]]--> %</th>
      <th class="rowshade"><!--[[-->Last<br>Attempt<!--]]--></th>
      <th class="rowshade"><!--[[-->Complete?<!--]]--></th>
    </tr>
    <%
      Dim vModsTitle, vCnt
      vCnt = 0
    ...
    <tr>
      ...
      <form name="fForm">
        ...
        <input type="button" onclick="location.href='<%=vUrl%>';" value="Excel" name="bExcel" id="bExcel" class="button100"><p><!--[[-->Excel Output contains the raw data used above.<!--]]--></p>
      </form>
      </td>
    </tr>
  </table>
