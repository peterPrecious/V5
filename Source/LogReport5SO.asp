...
<body>
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="3" style="border-collapse: collapse" bordercolor="#DDEEF9">
    ...
    <tr>
      ...
      <th nowrap height="30" align="left" bgcolor="#DDEEF9" bordercolor="#FFFFFF"><%=fIf(svCustPwd, "<!--{{-->Learner Id<!--}}-->", "<!--{{-->Password<!--}}-->")%></th>
      <th nowrap height="30" align="left" bgcolor="#DDEEF9" bordercolor="#FFFFFF"><!--[[-->Learner<!--]]--></th>
      <th nowrap height="30" bgcolor="#DDEEF9" bordercolor="#FFFFFF"><!--[[-->Date<!--]]--></th>
      <th nowrap height="30" align="left" bgcolor="#DDEEF9" bordercolor="#FFFFFF"><!--[[-->Title<!--]]--> </th>
...
'       If fCriteriaOk (svMembCriteria, vMemb_Criteria) Then
    ...
    <tr>
      ...
      %>
      <a href="LogReport5SO.asp"><!--[[-->Next Group<!--]]--></a>
      <%
        Else 
          Set oRs = Nothing
        End If      
